...
class MotorControl(Phidget):
    ...
    def __init__(self):
        ...
        self.dll.CPhidgetMotorControl_create(byref(self.handle))
    ...
    def getMotorCount(self):
        ...
        """
        motorCount = c_int()
        result = self.dll.CPhidgetMotorControl_getMotorCount(self.handle, byref(motorCount))
        if result > 0:
    ...
    def getVelocity(self, index):
        ...
        """
        veloctiy = c_double()
        result = self.dll.CPhidgetMotorControl_getVelocity(self.handle, c_int(index), byref(veloctiy))
        if result > 0:
            raise PhidgetException(result)
        else:
    ...
    def setVelocity(self, index, value):
        ...
        """
        result = self.dll.CPhidgetMotorControl_setVelocity(self.handle, c_int(index), c_double(value))
        if result > 0:
            raise PhidgetException(result)
    ...
    def setOnVelocityChangeHandler(self, velocityChangeHandler):
        ...
        result = self.dll.CPhidgetMotorControl_set_OnVelocityChange_Handler(self.handle, self.__onVelocityChange, None)
        if result > 0:
            raise PhidgetException(result)
    ...
    def getAcceleration(self, index):
        ...
        """
        accel = c_double()
        result = self.dll.CPhidgetMotorControl_getAcceleration(self.handle, c_int(index), byref(accel))
        if result > 0:
            raise PhidgetException(result)
        else:
            return accel.value
    ...
    def setAcceleration(self, index, value):
        ...
        """
        result = self.dll.CPhidgetMotorControl_setAcceleration(self.handle, c_int(index), c_double(value))
        if result > 0:
            raise PhidgetException(result)
    ...
    def getAccelerationMax(self, index):
        ...
        """
        accelMax = c_double()
        result = self.dll.CPhidgetMotorControl_getAccelerationMax(self.handle, c_int(index), byref(accelMax))
        if result > 0:
            raise PhidgetException(result)
        else:
    ...
    def getAccelerationMin(self, index):
        ...
        """
        accelMin = c_double()
        result = self.dll.CPhidgetMotorControl_getAccelerationMin(self.handle, c_int(index), byref(accelMin))
        if result > 0:
            raise PhidgetException(result)
        else:
    ...
    def getCurrent(self, index):
        ...
        """
        current = c_double()
        result = self.dll.CPhidgetMotorControl_getCurrent(self.handle, c_int(index), byref(current))
        if result > 0:
            raise PhidgetException(result)
        else:
    ...
    def setOnCurrentChangeHandler(self, currentChangeHandler):
        ...
        result = self.dll.CPhidgetMotorControl_set_OnCurrentChange_Handler(self.handle, self.__onCurrentChange, None)
        if result > 0:
            raise PhidgetException(result)
    ...
    def getInputCount(self):
        ...
        """
        inputCount = c_int()
        result = self.dll.CPhidgetMotorControl_getInputCount(self.handle, byref(inputCount))
        if result > 0:
            raise PhidgetException(result)
        else:
    ...
    def getInputState(self, index):
        ...
        """
        inputState = c_int()
        result = self.dll.CPhidgetMotorControl_getInputState(self.handle, c_int(index), byref(inputState))
        if result > 0:
            raise PhidgetException(result)
        else:
    ...
    def setOnInputChangeHandler(self, inputChangeHandler):
        ...
        result = self.dll.CPhidgetMotorControl_set_OnInputChange_Handler(self.handle, self.__onInputChange, None)
        if result > 0:
            raise PhidgetException(result)
